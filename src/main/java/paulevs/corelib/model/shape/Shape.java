...
public abstract class Shape {
	...
	public static void setWorldCulling(boolean ignore)
	{
		...
		else
		{
			...
			RENDER_WORLD[CoreLib.FACE_POS_Z] = tile.method_1618(tileView, POS.getX(), POS.getY() + 1, POS.getZ(), CoreLib.FACE_POS_Z);
			RENDER_WORLD[CoreLib.FACE_NEG_Z] = tile.method_1618(tileView, POS.getX(), POS.getY() - 1, POS.getZ(), CoreLib.FACE_NEG_Z);
		}
	}
